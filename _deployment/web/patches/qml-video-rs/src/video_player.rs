...
cpp! {{
    ...
    #include "src/cpp/MDKPlayer_web.cpp"
    #else
...
impl MDKPlayerWrapper {
    ...
    pub fn start_processing<F: FnMut(i32, f64, u32, u32, u32, u32, f64, f64, u32, &mut [u8]) -> bool + 'static>(&mut self, id: usize, width: usize, height: usize, custom_decoder: &str, yuv: bool, ranges_ms: Vec<(usize, usize)>, cb: F) {
        ...
        cpp!(unsafe [self as "MDKPlayerWrapper *", id as "size_t", width as "size_t", height as "size_t", yuv as "bool", custom_decoder as "const char *", ranges_ptr as "std::pair<size_t, size_t>*", ranges_len as "size_t", cb_ptr as "TraitObject2"] {
    ...
    pub fn stop_processing(&mut self, id: usize) {
        cpp!(unsafe [self as "MDKPlayerWrapper *", id as "size_t"] {
